[Version française](../../fr/axes/afterlife.md)

# After death

**Does something of us survive death?**
...
*[Plato](../philosophers/plato.md) · [Plotinus](../philosophers/plotinus.md)*

### Rebirth

Death is not an end but a relay: something continues from life to life, inheriting the deeds done. No creator is required for this law to operate, memory does not usually accompany the passage, and what is reborn need not be a soul: this life inherits from previous ones and prepares the next.

- In Buddhism, rebirth takes place without a soul: a stream of conditions is passed on, as one flame lights another, with no substance that travels.
- In Shankara's Advaita, rebirth is real at the conventional level but not the last word: liberation is precisely the end of rebirths, along with the ignorance that sustains the illusion of a separate self.

*[Buddha](../philosophers/buddha.md) · [Shankara](../philosophers/shankara.md)*
...
- **Would it still be me?** : A soul without memory, a re-created body, a stream reborn in another form: under what conditions would the survivor be me, and not someone else who resembles or continues me?
- **Immortal soul or resurrection?** : Does survival rest on the soul's nature, or on an act of God restoring the whole person, body included? Athens and Jerusalem part ways here, and the re-created body poses a riddle: would it be the same one, or a perfect copy?
- **Reborn without a soul?** : If no substantial self travels from life to life, what is reborn, and in what sense do my present deeds concern the one who will inherit their fruit? Is the flame that lights another the same flame or another?
- **Thinking without a brain?** : The mind is born, matures, and fails with the body, is befuddled by its wine, goes out under a blow: do these bonds prove that thought dies with the flesh, or only that the instrument conditions the playing without being the musician?
- **Believing what we hope?** : Survival is what we have most reason to desire and least means to verify: is a consoling belief thereby suspect, or does the origin of a hope say nothing about its truth?
- **Living on in one's works?** : Works, children, and memory prolong a name, not a consciousness: does this immortality by proxy deserve the word survival, or is it a consolation that changes the subject?

## Arguments

- *The immortal soul* · for : [The argument from the soul](../arguments/death-immortalist-hope.md)
- *The immortal soul* · against : [The flight objection](../arguments/death-flight-from-finitude.md)
- *The immortal soul* · against : [The identity objection](../arguments/death-identity-objection.md)
...
[Death](../axes/death.md) · [Existence of God](../axes/god-existence.md) · [Nature of the self](../axes/self-nature.md) · [The enigma of consciousness](../axes/consciousness-nature.md) · [The value of truth](../axes/truth-value.md) · [Where the sacred resides](../axes/transcendence.md) · [Nature of reality](../axes/reality-nature.md)
